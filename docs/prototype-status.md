...
The exact atomic T1 relation and two-seed repair are now preregistered; their
additive Lean/order certificate and executable re-sum are the next hard gate.
Full T1 statement assembly, cache constraint census, wrapper proof, local
