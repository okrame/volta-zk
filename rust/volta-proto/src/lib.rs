...
pub use c6_residual::{
    ...
    compile_c6_residual_fused_terminal_coefficients,
    compile_c6_residual_terminal_functional_relation_reference, replay_c6_residual_atomic_events,
    ...
    C6ResidualRetainedChallenges, C6ResidualTerminalFormKind, C6ResidualTerminalFunctionalRelation,
