...
pub use c6_residual::{
    ...
    C6ResidualClosureWitnessCensus, C6ResidualDigest, C6ResidualError,
    ...
    C6ResidualProductPublicClaim, C6ResidualPublicClaimsFrame, C6ResidualRelationChallenges,
    C6ResidualRelationManifest, C6ResidualRelationReferenceWitness, C6ResidualRelationRootBound,
    C6ResidualRetainedChallenges, C6ResidualTerminalFormKind, C6ResidualTerminalWeightSchedule,
    C6SourceWitness, C6ValueId, C6ValueOperation, C6_RESIDUAL_AUXILIARY_LANES,
    C6_RESIDUAL_AUXILIARY_PRODUCT_LANES, C6_RESIDUAL_AUXILIARY_QUADRATIC_FACTORS,
    C6_RESIDUAL_AUXILIARY_SEMANTIC_ENTRIES, C6_RESIDUAL_AUXILIARY_SEMANTIC_LOG2,
    C6_RESIDUAL_AUXILIARY_ZERO_LANES, C6_RESIDUAL_FUSED_MAX_COEFFICIENT_STATE_BYTES,
