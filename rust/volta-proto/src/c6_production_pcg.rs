...
pub const C62_PRODUCTION_SUFFIX_SUB_CORRELATIONS: usize = 24;
...
pub const C62_CONTINUATION_256_RESPONSE_FULL_CORRELATIONS: usize = 197_762;
pub const C62_CONTINUATION_512_RESPONSE_SUB_CORRELATIONS: usize = 1_795_150;
pub const C62_CONTINUATION_512_RESPONSE_FULL_CORRELATIONS: usize = 202_562;
pub const C62_CONTINUATION_1024_RESPONSE_SUB_CORRELATIONS: usize = 1_795_150;
pub const C62_CONTINUATION_1024_RESPONSE_FULL_CORRELATIONS: usize = 207_554;
pub const C62_GENESIS_SUB_CORRELATIONS: usize =
    C62_GENESIS_RESPONSE_SUB_CORRELATIONS + C62_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C62_GENESIS_FULL_CORRELATIONS: usize =
    C62_GENESIS_RESPONSE_FULL_CORRELATIONS + C62_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
pub const C62_GENESIS_RAW_CORRELATIONS: u64 =
    C62_GENESIS_SUB_CORRELATIONS as u64 + 2 * C62_GENESIS_FULL_CORRELATIONS as u64;
pub const C62_CONTINUATION_256_SUB_CORRELATIONS: usize =
    C62_CONTINUATION_256_RESPONSE_SUB_CORRELATIONS + C62_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C62_CONTINUATION_256_FULL_CORRELATIONS: usize =
    C62_CONTINUATION_256_RESPONSE_FULL_CORRELATIONS + C62_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
...
pub const C62_CONTINUATION_512_SUB_CORRELATIONS: usize =
    C62_CONTINUATION_512_RESPONSE_SUB_CORRELATIONS + C62_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C62_CONTINUATION_512_FULL_CORRELATIONS: usize =
    C62_CONTINUATION_512_RESPONSE_FULL_CORRELATIONS + C62_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
...
pub const C62_CONTINUATION_1024_SUB_CORRELATIONS: usize =
    C62_CONTINUATION_1024_RESPONSE_SUB_CORRELATIONS + C62_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C62_CONTINUATION_1024_FULL_CORRELATIONS: usize =
    C62_CONTINUATION_1024_RESPONSE_FULL_CORRELATIONS + C62_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
...
pub const C63_GENESIS_SUB_CORRELATIONS: usize =
    C62_GENESIS_RESPONSE_SUB_CORRELATIONS + C63_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C63_GENESIS_FULL_CORRELATIONS: usize =
    C62_GENESIS_RESPONSE_FULL_CORRELATIONS + C63_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
pub const C63_GENESIS_RAW_CORRELATIONS: u64 =
    C63_GENESIS_SUB_CORRELATIONS as u64 + 2 * C63_GENESIS_FULL_CORRELATIONS as u64;
pub const C63_CONTINUATION_256_SUB_CORRELATIONS: usize =
    C62_CONTINUATION_256_RESPONSE_SUB_CORRELATIONS + C63_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C63_CONTINUATION_256_FULL_CORRELATIONS: usize =
    C62_CONTINUATION_256_RESPONSE_FULL_CORRELATIONS + C63_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
pub const C63_CONTINUATION_256_RAW_CORRELATIONS: u64 = C63_CONTINUATION_256_SUB_CORRELATIONS as u64
    + 2 * C63_CONTINUATION_256_FULL_CORRELATIONS as u64;
pub const C63_CONTINUATION_512_SUB_CORRELATIONS: usize =
    C62_CONTINUATION_512_RESPONSE_SUB_CORRELATIONS + C63_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C63_CONTINUATION_512_FULL_CORRELATIONS: usize =
    C62_CONTINUATION_512_RESPONSE_FULL_CORRELATIONS + C63_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
pub const C63_CONTINUATION_512_RAW_CORRELATIONS: u64 = C63_CONTINUATION_512_SUB_CORRELATIONS as u64
    + 2 * C63_CONTINUATION_512_FULL_CORRELATIONS as u64;
pub const C63_CONTINUATION_1024_SUB_CORRELATIONS: usize =
    C62_CONTINUATION_1024_RESPONSE_SUB_CORRELATIONS + C63_PRODUCTION_SUFFIX_SUB_CORRELATIONS;
pub const C63_CONTINUATION_1024_FULL_CORRELATIONS: usize =
    C62_CONTINUATION_1024_RESPONSE_FULL_CORRELATIONS + C63_PRODUCTION_SUFFIX_FULL_CORRELATIONS;
...
fn registered_production_geometry(sub: usize, full: usize) -> Option<u64> {
    match (sub, full) {
        ...
        (C63_GENESIS_SUB_CORRELATIONS, C63_GENESIS_FULL_CORRELATIONS) => {
            Some(C63_GENESIS_RAW_CORRELATIONS)
        }
        (C63_CONTINUATION_256_SUB_CORRELATIONS, C63_CONTINUATION_256_FULL_CORRELATIONS) => {
            Some(C63_CONTINUATION_256_RAW_CORRELATIONS)
        }
        (C63_CONTINUATION_512_SUB_CORRELATIONS, C63_CONTINUATION_512_FULL_CORRELATIONS) => {
            Some(C63_CONTINUATION_512_RAW_CORRELATIONS)
        }
...
mod tests {
    ...
    #[test]
    fn c62_registered_geometries_match_the_measured_schedule() {
        assert_eq!(C62_GENESIS_RAW_CORRELATIONS, 5_347_602);
        assert_eq!(C62_CONTINUATION_256_RAW_CORRELATIONS, 2_192_228);
        assert_eq!(C62_CONTINUATION_512_RAW_CORRELATIONS, 2_201_828);
        assert_eq!(C62_CONTINUATION_1024_RAW_CORRELATIONS, 2_211_812);
        for (response_sub, response_full, allocation_sub, allocation_full) in [
            (
                C62_GENESIS_RESPONSE_SUB_CORRELATIONS,
                C62_GENESIS_RESPONSE_FULL_CORRELATIONS,
            ...
            assert_eq!(
                (allocation_sub, allocation_full),
                (
                    response_sub + C62_PRODUCTION_SUFFIX_SUB_CORRELATIONS,
                    response_full + C62_PRODUCTION_SUFFIX_FULL_CORRELATIONS,
                )
            );
        }
        for (sub, full, raw) in [
