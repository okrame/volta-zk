...
pub use c61_terminal_functional::{
    ...
    C61NativeVerifierChainStatement, C61SparseRationalCompilerOpeningPoints,
    C61SparseRationalCompilerOpeningStatement, C61SparseRationalCompilerOracles,
    C61SparseRationalProverOpeningStatement, C61SparseRationalVerifierOpeningStatement,
    ...
    C61_SPARSE_RATIONAL_INPUT_LOG2, C61_SPARSE_RATIONAL_PLAN_OPENINGS,
