...
| C6 role-local instance extraction codec | **CLEAN TWO-SEED RUN-OF-RECORD PASS; CLIENT MAP SETUP FIT CLOSED; RUNTIME RECORDER PENDING** (2026-07-29) | No response-value vector on wire; role-specific model-global maps; maximal-`+1` run codec fixed before measurement; strict ordinary-build decoder | Clean seed-24/25 runs reconstruct distinct instance digests and emit stable role artifacts.  The verifier map is **5,320,386 B** with **1,466 / 10,828,876 raw public/scalar slots**, **1,436 / 10,828,852 canonical slots** and **262 / 2,552,791 runs**; BLAKE3 `17ed0942...7183535`.  Client topology + map are **69,315,137 B**; paired PCG + setup envelope total **146,058,504 B**, leaving **3,941,496 B**.  Records `c6-instance-extraction-seed24-2026-07-29-3d8e2ea.json` / `c6-instance-extraction-seed25-2026-07-29-1817975.json`, SHA-256 `d641f0bc...b71921c` / `a4938bdd...533280`, are `git_dirty:false`, `diagnostic:false`, `pod_contacted:false`, `all_pass:true`.  No runtime, prover-time, residual or production claim. |
