...
record and pins `4,975,525` typed leaves.  Paired direct-subfield witness
extraction is also clean at `4,793,590` leaves per coordinate with no second
model run, but the full-field/ProductClosure DAG, cache constraint census,
wrapper proof, local end-to-end and hardware gates remain pending.
