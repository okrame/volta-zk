...
#[test]
fn c63_d22_and_d19_keep_full_104_bit_query_targets() {
    let cases = [
        (
            22,
            17,
            ...
            vec![243, 243, 112, 73, 73, 54, 43, 36],
            31,
            254,
        ),
        (
...
fn legacy_constructor_keeps_the_previous_derived_configuration() {
    let params = params(17, vec![1, 2, 3, 3, 4, 5, 6, 7], vec![1, 2, 2, 2, 2, 2, 2, 2, 2]);
