...
differential are also green; the source-ordinal stream gate, `CacheSegK` removal, the resident
provider path, production transition, envelope/backend, local end-to-end and
