...
pub use c6::{
    ...
    C6_CERTIFICATE_VERSION, C6_CLIENT_STATE_VERSION, C6_FASE_D_SETUP_BYTES,
    C6_FINAL_PROOF_CAP_BYTES, C6_LIGERO_QUERIES, C6_MAC_COORDINATES, C6_MAX_CONTEXT,
    C6_NEW_PAYLOAD_BUDGET_BYTES, C6_PAIRED_PCG_SETUP_BYTES, C6_PI_FINAL_CAP_BYTES,
    C6_RESPONSE_CAP_BYTES, C6_RETAINED_Q121_BASELINE_BYTES, C6_ROOFLINE_PI_FINAL_MAX_BYTES,
    C6_SETUP_CAP_BYTES, C6_SLOT_JOURNAL_VERSION, C6_TERMINAL_ONE_RAW_CAPACITY,
};
pub use c6_census::{
...
pub use c6_residual::{
    compile_c6_residual_atomic_relation_reference, C6CommittedResidualProgram,
    C6CompiledBaseKeyRlc, C6CompiledLinearResidual, C6CompiledLinearResidualMemoryCensus,
    C6CompiledPairedBaseKeyRlc, C6CompiledPairedResidualPlan, C6CompiledResidualBinding,
    C6CompiledResidualPlan, C6CompiledTerminalLinearForm, C6LeafId, C6LeafKind, C6LeafRole,
    C6PairedResidualAuxiliaryWitness, C6PairedResidualClosureWitness, C6PairedResidualLeafWitness,
    C6ProductPostCommit, C6ResidualAtomicFamily, C6ResidualAtomicReferenceCompilation,
    C6ResidualAtomicRelationStatement, C6ResidualAtomicWeightSchedule, C6ResidualAuxiliaryLane,
    C6ResidualAuxiliaryWitnessCensus, C6ResidualBaseShareContext, C6ResidualBuilder,
    C6ResidualCensus, C6ResidualClaimsBoundContext, C6ResidualClosureWitnessCensus,
    C6ResidualDigest, C6ResidualError, C6ResidualLeafColumn, C6ResidualPlan, C6ResidualPostCommit,
    ...
    C6ResidualTerminalWeightSchedule, C6SourceWitness, C6ValueId, C6ValueOperation,
    C6_RESIDUAL_AUXILIARY_LANES, C6_RESIDUAL_AUXILIARY_PRODUCT_LANES,
    ...
    C6_RESIDUAL_MAC_COORDINATES, C6_RESIDUAL_POST_ROOT_TERMINAL_STREAMS,
