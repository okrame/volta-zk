...
pub use c6_trace::{
    ...
    C6DecodedInstanceExtractionPlan, C6DecodedOperationPlan, C6InstalledOperationKind,
    C6InstalledOperationPlan, C6InstalledOperationPlanMemoryCensus, C6InstalledProductClosure,
