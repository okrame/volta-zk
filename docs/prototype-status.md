# Prototype Status Ledger (T1 CLOSED; X1 PASS; X2 FAIL immutable; X2b PASS; X3 PASS; X1--X3 CLOSED; R1/R1B DISPOSITIONS CLOSED; X4 OVERALL FAIL IMMUTABLE; X4b OFFICIAL FAIL — COMMIT/OPEN; X4c PHASE 1 COMPLETE — DROP DOMINANCE REFUTED LOCALLY; X4c PHASE 2 / V1 A100 ONLINE PASS; REAL-WEIGHT GPT-2 ACCELERATED REBUILD ADMITTED; X4d PHASE 3 A100 V1 PASS; X4d.1 PAIRED A100 OFFICIAL FAIL — FLATNESS; HISTORICAL k=1 G1 SYNC WAIVED ONCE; PHYSICAL COUNTERS PASS; X4d.2 PHASE 2 FAIL-CLOSED BEFORE RECORD — CUDA DELAYED-LINK TERMINAL MISMATCH; NO GATE VERDICT; CONTROL-PLANE STOP COMPLETE; C4 LIGERO INLINE PHASE 2 PREFLIGHT — LOCAL OVERLAY ADMISSION CORRECTION, NO PRODUCER WORKLOAD)
...
| C4 Ligero inline rate reduction | **PHASE 2 OWNER-AUTHORIZED; PREFLIGHT STOPPED BEFORE CHECKOUT/BUILD/WORKLOAD FOR LOCAL-OVERLAY ADMISSION CORRECTION; NO PERFORMANCE OR GATE VERDICT** (2026-07-27) | Return to inline T1 weight certification; same-build anchor `rate=1/4,Q=120` versus candidate `rate=1/8,Q=97`; no deferred settlement | Phase 1 preserves T1 boundary thinning, the two commitment layouts, `96+6` claims, fresh post-seal query timing, AES-PCG/MAC lifecycle and every non-PCS byte. New immutable `C4_WEIGHTS/C4_EMBED` double only code length and set `Q=97`; formula tests give exact candidate PCS/response/first-exchange **38,296,040 / 79,566,504 / 117,937,969 B**, a **4,977,848-B** response saving, with **78.86651649674867-bit** soundness above the exact **78.80929487391641-bit** anchor. Schema 11 adds fail-closed profile selection, exact geometry/byte/counter/soundness/device fields, current CUDA ABI 33 and no CPU fallback. The raw A100 validator and append-only paired selector require same SHA/instance/GPU/eight workers, distinct connection ledgers, equal non-PCS/correlation surfaces and both timing ratios `<=1.05x`. Scaled commit/open/verify and path/correction tamper negatives pass. The first authorized pod preflight confirmed one A100-SXM4-80GB with **81,152 MiB free**, **2,101,188,784 kB RAM**, **128 CPUs** and **128,832,397,312 B** free container disk, but correctly stopped before checkout/build/weights/PCG/workload because the local disk appears as `overlayfs` and `/workspace` is remote FUSE. A preregistered correction admits only the exact Docker-local overlay contract while retaining the **80,000,000,000-B** floor and rejecting FUSE/network storage. Historical local record `c4-ligero-local-2026-07-27-7bb4428.json`, SHA-256 `6ea4fa7a62847262c67f2bbeb45c199a2e24a9332ba1aed508d2ff5da91877e9`, retains its recorded design SHA-256 `bcc69cd39419c497dae45b695b15e5f1fd6a06e3f300d46e8581fb19976582eb`; it is not rewritten. No producer workload, A100 timing or gate verdict exists. X4/X4d history remains immutable and suspended. |
