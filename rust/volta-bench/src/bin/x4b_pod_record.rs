...
struct FoldMetricsRow {
    ...
    issue_queries_query_gather_wall_ns: u64,
    issue_queries_hashing_path_assembly_wall_ns: u64,
    issue_queries_encode_serialize_wall_ns: u64,
    issue_queries_teardown_wall_ns: u64,
    issue_queries_total_wall_ns: u64,
...
impl From<&GlobalOpenMetricsV4> for FoldMetricsRow {
    fn from(value: &GlobalOpenMetricsV4) -> Self {
        Self {
            ...
            sealed_fold_codeword_bytes: value.sealed_fold_codeword_bytes,
            sealed_fold_outer_cache_bytes: value.sealed_fold_outer_cache_bytes,
            sealed_fold_tree_count: value.sealed_fold_tree_count,
            sealed_fold_outer_level_vectors: value.sealed_fold_outer_level_vectors,
            serialized_fold_bytes: value.serialized_fold_bytes,
            serialized_packed_opening_bytes: value.serialized_packed_opening_bytes,
            issue_queries_query_gather_wall_ns: value.issue_queries_query_gather_wall_ns,
            issue_queries_hashing_path_assembly_wall_ns: value
                .issue_queries_hashing_path_assembly_wall_ns,
            issue_queries_encode_serialize_wall_ns: value.issue_queries_encode_serialize_wall_ns,
            issue_queries_teardown_wall_ns: value.issue_queries_teardown_wall_ns,
            issue_queries_total_wall_ns: value.issue_queries_total_wall_ns,
