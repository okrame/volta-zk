...
| C6 Δ-residual inline certificate | **FUSED SCALED C6RSC3 + BLIND HIDDEN-U + STRICT PACKED LINK GREEN; CACHE SOURCE/HASH NEXT; NO POD** (2026-07-31) | Hide direct `auth_corrections` and Ligero `u_vectors`; one inline native-field wrapper; fixed-capacity committed KV cache; 17 accepts plus retry reserve; no deferred settlement | Q=121 keeps complete soundness at **79.472744138609180097... bits**.  The `pi_final` roof remains **4,409,824 B** and complete response roof **33,586,456 B <=35,000,000 B**; paired setup and known first exchange remain **76,742,930 / 146,058,504 B**.  `C6HUB2` authenticates all hidden degree-two rounds and four terminal sources on both tapes, fixes slot 0 as live and slots 1--7 as public-zero per family, and is **5,416 B / 164 full correlations/tape** at production geometry.  The integrated scaled registry is now **48 residual + 32 hidden real + 48 cache/cache-auxiliary stand-in =128**.  The packed link remains **3,613,362 B / 100 full/tape**.  The descendant numerator is **6,725+141²=26,606<2^16**; Lean is **3,260 jobs / 315 audited targets**, standard axioms only.  No response field is removed yet; production all-participant scheduling, cache hash/argument, envelope/backend, CUDA/real-PCG/time and hardware verdict remain pending. |
