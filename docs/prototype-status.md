...
still pending connection to the fused grand residual.  Production
multi-layer/band orchestration, persistent prefixes, the resident provider
path, response-field removal, envelope/backend, complete local end-to-end and
