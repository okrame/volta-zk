...
// is rand_chacha 0.3.1's ChaCha8Rng.  This is for shared mock-PCG mask and
// correlation seeds only: it must never derive Fiat-Shamir challenges or any
// verifier-only secret (in particular Delta).
