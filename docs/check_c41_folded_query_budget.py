...
MEASURED_ANCHOR_PROVER_SECONDS = 4.037166616
MEASURED_CANDIDATE_PROVER_SECONDS = 4.035909735
MEASURED_PROVER_RATIO = MEASURED_CANDIDATE_PROVER_SECONDS / MEASURED_ANCHOR_PROVER_SECONDS
MEASURED_CANDIDATE_PEAK_BYTES = 18_403_517_364
REAL_E2E_PROVER_SECONDS = 7.942478252
REAL_E2E_PROVER_RATIO = REAL_E2E_PROVER_SECONDS / ANCHOR_PROVE_SECONDS
REAL_E2E_PROOF_BYTES = 67_831_020
REAL_E2E_PEAK_BYTES = 18_056_184_148
REAL_E2E_SOUNDNESS_BITS = 78.80929487390853
REAL_E2E_WEIGHT_ZK_BITS = 120.0170064253057
...
assert MEASURED_PROVER_RATIO < PROVER_TIME_GATE_RATIO
assert MEASURED_CANDIDATE_PROVER_SECONDS < PROVER_TIME_GATE_SECONDS
assert MEASURED_CANDIDATE_PEAK_BYTES < DEVICE_CAP
assert REAL_E2E_PROVER_RATIO > PROVER_TIME_GATE_RATIO
assert REAL_E2E_PROOF_BYTES < RESPONSE_CAP
assert REAL_E2E_PEAK_BYTES < DEVICE_CAP
assert REAL_E2E_SOUNDNESS_BITS > 78
assert REAL_E2E_WEIGHT_ZK_BITS > 78
...
print(
    {
        ...
        "measured_anchor_prover_seconds": MEASURED_ANCHOR_PROVER_SECONDS,
        "measured_candidate_prover_seconds": MEASURED_CANDIDATE_PROVER_SECONDS,
        "measured_prover_ratio": MEASURED_PROVER_RATIO,
        "measured_candidate_peak_bytes": MEASURED_CANDIDATE_PEAK_BYTES,
        "measured_prover_time_gate": "pass on clean 7c0e58a; timing credit only",
        "real_e2e_proof_bytes": REAL_E2E_PROOF_BYTES,
        "real_e2e_prover_seconds": REAL_E2E_PROVER_SECONDS,
        "real_e2e_prover_ratio": REAL_E2E_PROVER_RATIO,
        "real_e2e_prover_gate": "fail on clean a3604cf",
        "real_e2e_peak_bytes": REAL_E2E_PEAK_BYTES,
        "real_e2e_soundness_bits": REAL_E2E_SOUNDNESS_BITS,
        "real_e2e_weight_zk_bits": REAL_E2E_WEIGHT_ZK_BITS,
