# Prototype Status Ledger (T1 CLOSED; X1 PASS; X2 FAIL immutable; X2b PASS; X3 PASS; X1--X3 CLOSED; R1/R1B DISPOSITIONS CLOSED; X4 OVERALL FAIL IMMUTABLE; X4b OFFICIAL FAIL — COMMIT/OPEN; X4c PHASE 1 COMPLETE — DROP DOMINANCE REFUTED LOCALLY; X4c PHASE 2 / V1 A100 ONLINE PASS; REAL-WEIGHT GPT-2 ACCELERATED REBUILD ADMITTED; X4d PHASE 3 A100 V1 PASS; X4d.1 PAIRED A100 OFFICIAL FAIL — FLATNESS; HISTORICAL k=1 G1 SYNC WAIVED ONCE; PHYSICAL COUNTERS PASS; X4d.2 PHASE 2 FAIL-CLOSED BEFORE RECORD — CUDA DELAYED-LINK TERMINAL MISMATCH; NO GATE VERDICT; CONTROL-PLANE STOP COMPLETE; C4 LIGERO INLINE PHASE 2 FAIL-CLOSED AT ANCHOR RESOURCE ADMISSION — 13 EFFECTIVE CPUs <16; NO WORKLOAD, PERFORMANCE RECORD OR GATE VERDICT; POD STOPPED)
...
| C4 Ligero inline rate reduction | **PHASE 2 FAIL-CLOSED AT ANCHOR RESOURCE ADMISSION; 13 EFFECTIVE CPUs <16; NO WORKLOAD, PERFORMANCE RECORD OR GATE VERDICT; CANDIDATE NOT STARTED; POD STOPPED** (2026-07-27) | Return to inline T1 weight certification; same-build anchor `rate=1/4,Q=120` versus candidate `rate=1/8,Q=97`; no deferred settlement; any new host/pair requires a new owner GO | Phase 1 preserves T1 boundary thinning, the two commitment layouts, `96+6` claims, fresh post-seal query timing, AES-PCG/MAC lifecycle and every non-PCS byte. New immutable `C4_WEIGHTS/C4_EMBED` double only code length and set `Q=97`; formula tests give exact candidate PCS/response/first-exchange **38,296,040 / 79,566,504 / 117,937,969 B**, a **4,977,848-B** response saving, with **78.86651649674867-bit** soundness above the exact **78.80929487391641-bit** anchor. Schema 11 adds fail-closed profile selection, exact geometry/byte/counter/soundness/device fields, current CUDA ABI 33 and no CPU fallback. The corrected clean checkpoint `3058c3c` admitted the exact Docker-local overlay, built ABI 33, passed **39** accelerator CUDA tests, **5** PCS CUDA tests, both production leakage smokes and the complete release CUDA workspace. The sole anchor invocation then stopped before loading weights: Linux exposed 128 online CPUs and cpuset `0-127`, but `cpu.max=1360000 100000` gives only 13.6 quota CPUs, conservatively reported as **13** against the frozen minimum **16**. No PCG store, warmup, repetition or raw anchor record exists; anchor was not retried, rate8 and the paired selector did not start, and every C4 gate is **NOT EVALUATED**. Obstruction record `c4-phase2-anchor-admission-obstruction-2026-07-27-3058c3c.json`, SHA-256 `535fc314608f94278d2b44cb0703be685f1a8b205bc766ecb65cc8c811dd4f97`. Pod-local `runpodctl stop pod zrt36y5g68az7q` returned stopped and an independent SSH probe was refused; teardown record `c4-control-plane-teardown-2026-07-27-3058c3c.json`, SHA-256 `fe65a850fc68aa653edc22738608c9f65ef2a76b90e26620abd638f841badaea`. Historical T1/C4-local/X4 records and design digests remain immutable. |
