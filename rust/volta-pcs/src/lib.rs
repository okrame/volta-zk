...
pub use c61_terminal_functional::{
    ...
    C61_MODEL_OPENING_TARGETS, C61_SPARSE_RATIONAL_BLIND_ARITHMETIC_DIGEST_BYTES,
    ...
    C61_SPARSE_RATIONAL_SEMANTIC_RESPONSE_OPENINGS, C61_TERMINAL_FUNCTIONAL_PROOF_REPETITIONS,
    C61_TERMINAL_FUNCTIONAL_RELATION_LOG2,
};
