...
pub const C62_GENESIS_SUB_CORRELATIONS: usize = 4_892_214;
pub const C62_GENESIS_FULL_CORRELATIONS: usize = 226_917;
pub const C62_GENESIS_RAW_CORRELATIONS: u64 =
    C62_GENESIS_SUB_CORRELATIONS as u64 + 2 * C62_GENESIS_FULL_CORRELATIONS as u64;
pub const C62_CONTINUATION_256_SUB_CORRELATIONS: usize = 1_795_150;
pub const C62_CONTINUATION_256_FULL_CORRELATIONS: usize = 197_762;
...
pub const C62_CONTINUATION_512_SUB_CORRELATIONS: usize = 1_795_150;
pub const C62_CONTINUATION_512_FULL_CORRELATIONS: usize = 202_562;
...
pub const C62_CONTINUATION_1024_SUB_CORRELATIONS: usize = 1_795_150;
pub const C62_CONTINUATION_1024_FULL_CORRELATIONS: usize = 207_554;
...
mod tests {
    ...
    fn c62_registered_geometries_match_the_measured_schedule() {
        assert_eq!(C62_GENESIS_RAW_CORRELATIONS, 5_346_048);
        assert_eq!(C62_CONTINUATION_256_RAW_CORRELATIONS, 2_190_674);
        assert_eq!(C62_CONTINUATION_512_RAW_CORRELATIONS, 2_200_274);
        assert_eq!(C62_CONTINUATION_1024_RAW_CORRELATIONS, 2_210_258);
        for (sub, full, raw) in [
            (
