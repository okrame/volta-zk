...
//!
//! P7 phase A uses a trusted-dealer base VOLE stub from a shared seed, then
//! charges the in-repo expansion work: GGM single-point noise, regular-noise
//! local-linear LPN expansion, and consistency-check arithmetic. It is not the
//! phase-B two-party setup.
